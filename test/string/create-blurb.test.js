...
describe('create blurb with length', () => {
    ...
    it('length edge case: 0', () => {
        assert.equal("hello world".createBlurb(0), "");
    });
    it('length edge case word border-1', () => {
        assert.equal("hello world how".createBlurb(10), "hello...");
    });

    it('length edge case word border', () => {
        assert.equal("hello world how".createBlurb(11), "hello world...");
    });

    it('length edge case word border + 1', () => {
        assert.equal("hello world how".createBlurb(12), "hello world...");
    });
...
describe('create blurb with min', () => {
    ...
    it('length edge case: 0', () => {
        assert.equal("hello world".createBlurb(0, 0), "");
    });
    it('length edge case word border-1', () => {
        assert.equal("hello world how".createBlurb(10, 10), "hello...");
    });

    it('length edge case word border', () => {
        assert.equal("hello world how".createBlurb(11, 11), "hello world...");
    });

    it('length edge case word border + 1', () => {
        assert.equal("hello world how".createBlurb(12, 12), "hello world...");
    });
    ...
    it('different min blurb', () => {
        assert.equal("hello world\nhow are you\nI am good".createBlurb(30, 25), "hello world\nhow are you...");
    });
});
